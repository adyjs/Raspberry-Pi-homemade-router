...
$ssid = shell_exec("iw dev wlan_built_in info | awk '/ssid/{print $2}'");

$wirelessIP = shell_exec("ifconfig wlan_built_in | egrep '(inet)\b' | awk '{print $2}'");
$wirelessMac = shell_exec("iw dev wlan_built_in info | awk '/addr/{print $2}'");
...
<article id="info">
	...
	<table>
		<tr>
			<td class="td-item-name">Status</td>
			<td>$status</td>
		</tr>
		<tr>
			<td class="td-item-name">SSID</td>
			<td>$ssid</td>
		</tr>
		<tr>
			<td class="td-item-name">IP</td>
			<td>$wirelessIP</td>
		</tr>
		<tr>
			<td class="td-item-name">MAC</td>
			<td>$wirelessMac</td>
		</tr>
	</table>
	<h2 class="sub-title">DHCP Clients</h2>
